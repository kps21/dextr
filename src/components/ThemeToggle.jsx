  ...
  return (
    <button
      ...
      className="relative w-14 h-7 rounded-full p-1 transition-all duration-500 
                 bg-gray-200 dark:bg-emerald-500/20 border border-gray-300 dark:border-emerald-500/30
                 shadow-inner group focus:outline-none"
    ...
    >
      ...
      <div
        className={`w-5 h-5 rounded-full shadow-md transform transition-transform duration-500 flex items-center justify-center
                   ${
                     theme === "dark"
                       ? "translate-x-7 bg-emerald-500 text-white"
      ...
      {/* Subtle Background Icons (Visible on larger widths) */}
