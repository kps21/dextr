...
function DashboardStocks() {
  ...
  return (
    <>
      <div className="relative overflow-hidden mt-6 rounded-2xl border border-white/20 dark:border-white/10 shadow-2xl bg-white/40 dark:bg-white/5 backdrop-blur-xl">
        <div className="overflow-x-auto">
          <h1 className="text-xl font-bold pt-4 pl-5 text-gray-800 dark:text-white tracking-tight">
            Your Portfolio
          </h1>
